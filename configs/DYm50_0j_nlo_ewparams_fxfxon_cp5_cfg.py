...
# with command line options: Configuration/VGenStudies/python/DYm50_0j_nlo_ewparams_fxfxon_cp5_cff.py --fileout file:DYm50_0j_nlo_ewparams_fxfxon_cp5.root --mc --eventcontent NANOAODSIM --datatier NANOAOD --conditions auto:mc --step LHE,GEN,NANOGEN --python_filename configs/DYm50_0j_nlo_ewparams_fxfxon_cp5_cfg.py --customise_commands process.RandomNumberGeneratorService.externalLHEProducer.initialSeed=999 --nThreads 12 -n 20000 --no_exec
...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('Configuration/VGenStudies/python/DYm50_0j_nlo_ewparams_fxfxon_cp5_cff.py nevts:20000'),
...
process.NANOAODSIMoutput = cms.OutputModule("NanoAODOutputModule",
    ...
    fileName = cms.untracked.string('file:DYm50_0j_nlo_ewparams_fxfxon_cp5.root'),

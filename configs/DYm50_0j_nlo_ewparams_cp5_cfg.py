...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('Configuration/VGenStudies/python/DYm50_0j_nlo_ewparams_cp5_cff.py nevts:20000'),
...
process.llgenfilter = cms.EDFilter("MCMultiParticleFilter",
...
process.ProductionFilterSequence = cms.Sequence(process.generator+process.llgenfilter)

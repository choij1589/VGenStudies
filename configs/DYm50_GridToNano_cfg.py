...
# with command line options: Configuration/VGenStudies/python/DYm50_GridToNano_cff.py --fileout file:DYm50_GridToNano.root --mc --eventcontent NANOAODGEN --datatier NANOAOD --conditions auto:mc --step LHE,GEN,NANOGEN --python_filename configs/DYm50_GridToNano_cfg.py --customise_commands process.RandomNumberGeneratorService.externalLHEProducer.initialSeed=999 -n 500 --no_exec
...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('Configuration/VGenStudies/python/DYm50_GridToNano_cff.py nevts:500'),
...
process.NANOAODGENoutput = cms.OutputModule("NanoAODOutputModule",
    ...
    fileName = cms.untracked.string('file:DYm50_GridToNano.root'),
...
process.externalLHEProducer = cms.EDProducer("ExternalLHEProducer",
    args = cms.vstring('root://eosuser.cern.ch//eos/user/c/choij/GenValidation/gridpacks/dyellell012j_5f_NLO_FXFX_tarball.tar.xz'),

...
# with command line options: Configuration/VGenStudies/python/DYm50_1j_nlo_cuep5m1_cff.py --fileout file:DYm50_1j_nlo_cuep5m1.root --mc --eventcontent NANOAODSIM --datatier NANOAOD --conditions auto:mc --step LHE,GEN,NANOGEN --python_filename configs/DYm50_1j_nlo_cuep5m1_cfg.py --customise_commands process.RandomNumberGeneratorService.externalLHEProducer.initialSeed=999 -n 30 --no_exec
...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('Configuration/VGenStudies/python/DYm50_1j_nlo_cuep5m1_cff.py nevts:30'),
...
process.NANOAODSIMoutput = cms.OutputModule("NanoAODOutputModule",
    ...
    fileName = cms.untracked.string('file:DYm50_1j_nlo_cuep5m1.root'),
...
process.externalLHEProducer = cms.EDProducer("ExternalLHEProducer",
    args = cms.vstring('/cvmfs/cms.cern.ch/phys_generator/gridpacks/slc6_amd64_gcc481/13TeV/madgraph/V5_2.2.2/dyll012j_5f_NLO/dyll1j_5f_NLO/v1/dyll1j_5f_NLO_tarball.tar.xz'),

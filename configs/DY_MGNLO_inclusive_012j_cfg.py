...
# with command line options: Configuration/VGenStudies/python/DY_MGNLO_inclusive_012j_cff.py --fileout file:DY_MGNLO_inclusive_012j.root --mc --eventcontent NANOAODGEN --datatier NANOAOD --conditions auto:mc --step LHE,GEN,NANOGEN --python_filename configs/DY_MGNLO_inclusive_012j_cfg.py --customise_commands process.RandomNumberGeneratorService.externalLHEProducer.initialSeed=999 -n 20000 --no_exec
...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('Configuration/VGenStudies/python/DY_MGNLO_inclusive_012j_cff.py nevts:20000'),
...
process.NANOAODGENoutput = cms.OutputModule("NanoAODOutputModule",
    ...
    fileName = cms.untracked.string('file:DY_MGNLO_inclusive_012j.root'),
